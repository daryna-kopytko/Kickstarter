...
document.querySelector('.actions-desk__buttons-en').addEventListener('click', ()=>getChangeLanguage('en'));
document.querySelector('.actions-desk__buttons-en').addEventListener('click', ()=>getChangeLanguage('en'));
document.querySelector('.actions-desk__buttons-ua').addEventListener('click', ()=>getChangeLanguage('ua'));
document.querySelector('.actions-desk__buttons-ua').addEventListener('click', ()=>getChangeLanguage('ua'));
//зміна слайдy
...
function changeSlide(direction) {
    ...
    if (direction >= totalSlides) currentSlide = 0;
